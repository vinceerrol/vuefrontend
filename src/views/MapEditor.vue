  ...
  methods: {
    ...
    editBuilding(building) {
      ...
      this.buildingForm = {
        ...
        image_preview: building.image_path ? (process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/') + building.image_path : null,
        modal_image: null, // Will be set if user selects a new modal image
        modal_image_preview: building.modal_image_path ? (process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/') + building.modal_image_path : null,
        ...
        employees: building.employees ? building.employees.map(emp => ({
          ...
          email: emp.email || '',
          image: null,
          image_preview: emp.employee_image ? (process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/') + emp.employee_image : null,
      ...
      try {
        ...
        if (this.editingBuilding) {
          ...
          await new Promise((resolve, reject) => {
            ...
            xhr.open('POST', `${process.env.VUE_APP_API_BASE || 'https://api.isuecampusmap.site/api'}/buildings/${this.editingBuilding.id}`)
    ...
    editMap(map) {
      ...
      this.mapForm = { 
        ...
        image_path: map.image_path ? (process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/') + map.image_path : null
      }
    ...
    getImagePath(building) {
      ...
      if (building.image_path) {
        return (process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/') + building.image_path
      }
      ...
      try {
        ...
        freshBuildings.forEach(apiBldg => {
          ...
          if (apiBldg.image_path) {
            ...
            img.src = `${process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/'}${apiBldg.image_path}`
        }
        })
        
        // 5. Check Laravel public storage link
        try {
          const testURL = (process.env.VUE_APP_STORAGE_BASE || 'https://api.isuecampusmap.site/storage/') + 'test-access.txt'
